...
\hline
И (Коньюнкция) & and & \& & \booleantable\&0001 \\
\hline
ИЛИ (Дизъюнкция) & or & | & \booleantable|0111 \\
\hline
Не (Отрицание) & not & $\sim$ & \booleantableunar{$\sim$}10 \\
\hline
...
В дискретной математике эти операции применяются только к булевым значениям, однако в языках программирования их можно применять и к целым числам. Например,
\begin{equation}
\label{example}
